...
def get_no_cat_error():
    ...
    return "at least <b>%d</b> images are required for each category. Please add the missing images and (re-)train the classifiers for updated results." % req_images_per_cat
